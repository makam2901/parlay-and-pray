...
class Dream11Predictor:
    ...
    def predict_team(self, home_team, away_team,min_roles, venue=None, load_saved_models=False):
        ...
        optimal_team = build_role_constrained_team(
            adjusted_points, self.players, self.venue, home_team, away_team,
            max_players=11, max_credits=100, max_per_team=7,
            min_roles=min_roles,
            max_roles={"WK": 2, "BAT": 5, "AR": 3, "BWL": 5}
        )
